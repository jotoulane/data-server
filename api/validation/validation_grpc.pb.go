...
const (
	Validation_GetValidation_FullMethodName = "/api.validation.Validation/GetValidation"
)
...
type ValidationClient interface {
	GetValidation(ctx context.Context, in *GetValidationRequest, opts ...grpc.CallOption) (*GetValidationReply, error)
}
...
func (c *validationClient) GetValidation(ctx context.Context, in *GetValidationRequest, opts ...grpc.CallOption) (*GetValidationReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetValidationReply)
	err := c.cc.Invoke(ctx, Validation_GetValidation_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ValidationServer interface {
	GetValidation(context.Context, *GetValidationRequest) (*GetValidationReply, error)
...
func (UnimplementedValidationServer) GetValidation(context.Context, *GetValidationRequest) (*GetValidationReply, error) {
...
func _Validation_GetValidation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetValidationRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ValidationServer).GetValidation(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Validation_GetValidation_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ValidationServer).GetValidation(ctx, req.(*GetValidationRequest))
	}
...
var Validation_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.validation.Validation",
	HandlerType: (*ValidationServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetValidation",
			Handler:    _Validation_GetValidation_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "api/validation/validation.proto",
}
